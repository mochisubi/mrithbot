...
(function (parent) {
    ...
    parent.words = [
        ...
        "consequat", "convallis", "cras", "cum", "SCREAMS", "cursus", "dapibus", "diam", "dictum", "dictumst",
        "dignissim", "dis", "dolor", "dolore", "do", "uwu", "dui", "duis", "egestas", "eget", "eiusmod", "eleifend",
        "elementum", "elit", "enim", "erat", "eros", "est", "et", "etiam", "like", "euismod", "facilisi", "facilisis",
        "fames", "faucibus", "hhhhHH", "HEAVY BREATHING", "feugiat", "fringilla", "fusce", "gravida", "habitant", "habitasse",
        "hac", "aAAAAA", "iaculis", "EEEEEE", "imperdiet", "in", "incididunt", "integer", "interdum", "I’m gonna eat you", "justo",
        "labore", "lacinia", "lacus", "laoreet", "lectus", "leo", "libero", "ligula", "lobortis", "Yummy", "luctus",
        "maecenas", "magna", "magnis", "malesuada", "massa", "mattis", "eat me", "metus", "mi", "molestie", "mollis",
        "montes", "morbi", "aa", "nam", "nascetur", "natoque", "no,,, we wont do that", "neque", "netus", "nibh", "nisi", "nisl", "non",
        ...
        "pulvinar", "purus", "aaaaa", "quis", "quisque", "rhoncus", "ridiculus", "risus", "rutrum", "sagittis", "sapien",
        "scelerisque", "sed", "sem", "she sobs !!!", "senectus", "sit", "sociis", "owo", "sollicitudin", "suscipit",
    ...
    parent.generate = function (num_sentences, min_words, max_words, addFirstCanon) {
        ...
        if (typeof min_words == "undefined")min_words =4;
        if (typeof max_words == "undefined")max_words = 16;
        if (typeof addFirstCanon == "undefined")addFirstCanon = false;
